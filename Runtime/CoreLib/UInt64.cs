...
namespace System
{
    ...
    public struct UInt64 : IComparable<UInt64>, IEquatable<UInt64>, IFormattable
    {
		...
		{
			return Int64.FromUInt64(~a) + Int64.One;
		}
		...
		//TODO Casts
		public static UInt64 FromInt64(Int64 a)
		{
			return new UInt64(a.Low, a.Mid, a.High);
		}

		public static UInt64 FromByte(Byte a)
		{
			return new UInt64(a, 0, 0);
		}

		public static UInt64 FromSByte(SByte a)
		{
			return new UInt64(a, a < 0 ? 0xffffff : 0, a < 0 ? 0xffff : 0);
		}

		public static UInt64 FromUInt16(UInt16 a)
		{
			return new UInt64(a, 0, 0);
		}

		public static UInt64 FromInt16(Int16 a)
		{
			return new UInt64(a, a < 0 ? 0xffffff : 0, a < 0 ? 0xffff : 0);
		}

		public static UInt64 FromUInt32(UInt32 a)
		{
			return new UInt64((Int32)a, (Int32)(a >> 24), 0);
		}

		public static UInt64 FromInt32(Int32 a)
		{
			return new UInt64(a, a >> 24, a < 0 ? 0xffff : 0);
		}

		public static UInt64 FromDouble(Double a)
		{
			if (a < 0)
		...
		public static UInt64 FromSingle(Single a)
		{
			return FromDouble((double)a);
		}
		...
		public static Byte ToByte(UInt64 a)
		{
			return (Byte)(a.Low & Byte.MaxValue);
		}

		public static SByte ToSByte(UInt64 a)
		{
			return (SByte)(a.Low & Byte.MaxValue);
		}

		public static UInt16 ToUInt16(UInt64 a)
		{
			return (UInt16)(a.Low & UInt16.MaxValue);
		}

		public static Int16 ToInt16(UInt64 a)
		{
			return (Int16)(a.Low & UInt16.MaxValue);
		}

		public static UInt32 ToUInt32(UInt64 a)
		{
		...
		public static Int32 ToInt32(UInt64 a)
		{
			//return (UInt32)((a.Low | a.Mid << 24) & UInt32.MaxValue);
			// return (a.$low | a.$mid << 24) & 4294967295;
			throw new NotImplementedException();
		...
		public static Double ToDouble(UInt64 a)
		{
			return 16777216.0 * ((16777216.0 * a.High) + a.Mid) + a.Low;
		}

		public static Single ToSingle(UInt64 a)
		{
