...
ss_Int64.op_Explicit = function (a) {
    var r = ss_Int64.op_Explicit$a($ss_UInt64.op_Explicit(Math.abs(a)));
    return ((a < 0) ? ss_Int64.op_UnaryNegation(r) : r);
};
ss_Int64.op_Explicit$1 = function (a) {
    var r = ss_Int64.op_Explicit$a($ss_UInt64.op_Explicit$4(Math.abs(a)));
    return ((a < 0) ? ss_Int64.op_UnaryNegation(r) : r);
};
ss_Int64.fromDecimal = function (a) {
    var r = ss_Int64.op_Explicit$a($ss_UInt64.fromDecimal(Math.abs(a)));
    return ((a < 0) ? ss_Int64.op_UnaryNegation(r) : r);
};
...
ss_Int64.op_Explicit$3 = function (a) {
    return (a.get_$isNegative() ? -$ss_UInt64.op_Explicit$7($ss_UInt64.op_Explicit$5(ss_Int64.op_UnaryNegation(a))) : $ss_UInt64.op_Explicit$7($ss_UInt64.op_Explicit$5(a)));
};
ss_Int64.op_Explicit$7 = function (a) {
    return (a.get_$isNegative() ? -$ss_UInt64.op_Explicit$b($ss_UInt64.op_Explicit$5(ss_Int64.op_UnaryNegation(a))) : $ss_UInt64.op_Explicit$b($ss_UInt64.op_Explicit$5(a)));
};
ss_Int64.toDecimal = function (a) {
    return (a.get_$isNegative() ? -$ss_UInt64.toDecimal($ss_UInt64.op_Explicit$5(ss_Int64.op_UnaryNegation(a))) : $ss_UInt64.toDecimal($ss_UInt64.op_Explicit$5(a)));
};
ss.initClass(ss_Int64, ss, {
    ...
    toString$1: function (radix) {
        return (this.get_$isNegative() ? ('-' + $ss_UInt64.op_Explicit$6(ss_Int64.op_UnaryNegation(this)).toString$1(radix)) : $ss_UInt64.op_Explicit$6(this).toString$1(radix));
    },
